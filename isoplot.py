...
url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID
...
#plot data for site1
plt.scatter(dfo['obs'], dfh['obs'], marker = 'o', color = 'black', label = 'all data')
#plot recent data
...
plt.scatter(dfo['obs'][-1:], dfh['obs'][-1:], color = 'black', s = 200, marker = '*', label = 'last data') #last
#label
