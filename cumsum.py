...
#site1   
url= 'https://fits.geonet.org.nz/observation?typeID='+typeID1+'&methodID='+methodID1+'&siteID='+siteID1+'&networkID='+networkID1
df1 = pd.read_csv(url, names=names, skiprows=1, index_col = 0, parse_dates={"Datetime" : ['dt']})
#site2   
url= 'https://fits.geonet.org.nz/observation?typeID='+typeID2+'&methodID='+methodID2+'&siteID='+siteID2+'&networkID='+networkID2
df2 = pd.read_csv(url, names=names, skiprows=1, index_col = 0, parse_dates={"Datetime" : ['dt']})
#site3   
url= 'https://fits.geonet.org.nz/observation?typeID='+typeID3+'&methodID='+methodID3+'&siteID='+siteID3+'&networkID='+networkID3
df3 = pd.read_csv(url, names=names, skiprows=1, index_col = 0, parse_dates={"Datetime" : ['dt']})
#site4   
url= 'https://fits.geonet.org.nz/observation?typeID='+typeID4+'&methodID='+methodID4+'&siteID='+siteID4+'&networkID='+networkID4
df4 = pd.read_csv(url, names=names, skiprows=1, index_col = 0, parse_dates={"Datetime" : ['dt']})
...
ax1.bar(dfmean.index, dfmean, width = 3, color='red', edgecolor='red', align='edge')
...
plt.title('All observations: resample = '+rs+', cumulative difference relative to mean ('+mean+')')
#save plot
