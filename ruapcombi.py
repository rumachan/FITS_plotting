...
for nday, day in days:
  ...
  plt.plot(df['Datetime'], df['obs'], marker='None', color = 'red', linewidth = 2, label = sitename) 
  ...
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  plt.plot(df['Datetime'], df['obs'], marker='o', markersize=10, color = 'green', linewidth = 2, label = sitename) 
  ...
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  plt.plot(df['Datetime'], df['obs'], marker='o', markersize=10, color = 'blue', linewidth = 2, label = sitename) 
  ...
  for (n, water) in enumerate(waterdata):
    ...
    url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
    if (n == 0):
      dftds = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
    else:
      df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
      dftds['obs'] = dftds['obs'] + df['obs']

  ax2.plot(dftds['Datetime'], dftds['obs'], marker='o', markersize=10, color = 'red', linewidth = 2, label = 'TDS') 
  ...
  print siteID, networkID, typeID, methodID
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  dfmg = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  cl = config.get('mgcl', 'cl')
  (siteID, networkID, typeID, methodID) = getsitesingle(cl)
  print siteID, networkID, typeID, methodID
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  dfcl = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  ...
  ax2a.plot(mg['Datetime'], dfmgcl, marker='o', markersize=10, color = 'blue', linewidth = 2, label = 'Mg/Cl')
  ...
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  plt.plot(df['Datetime'], df['obs'], marker='o', markersize=10, color = 'red', linewidth = 2, label = typeID+' '+methodID) 
  ...
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  plt.plot(df['Datetime'], df['obs'], marker='^', markersize=10, color = 'red', linewidth = 2, label = typeID+' '+methodID) 
  ...
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  df = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  plt.plot(df['Datetime'], df['obs'], marker='o', markersize=10, color = 'green', linewidth = 2, label = typeID+' '+methodID) 
  ...
  df['obs'] = df['obs'] * 100
  plt.plot(df['Datetime'], df['obs'], marker='o', markersize=10, color = 'blue', linewidth = 2, label = typeID+' '+methodID+' x 100') 
  ...
  ax3a.plot(df['Datetime'], dftpd, marker='o', markersize=10, color = 'blue', linewidth = 2)
  ...
  print siteID, networkID, typeID, methodID
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  dfso2cosp = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})

  so2cont = config.get('molar', 'so2cont')
  (siteID, networkID, typeID, methodID) = getsitesingle(so2cont)
  print siteID, networkID, typeID, methodID
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  dfso2cont = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})

  co2cont = config.get('molar', 'co2cont')
  (siteID, networkID, typeID, methodID) = getsitesingle(co2cont)
  print siteID, networkID, typeID, methodID
  url= 'https://fits.geonet.org.nz/observation?typeID='+typeID+'&siteID='+siteID+'&networkID='+networkID+'&methodID='+methodID+'&days='+day
  dfco2cont = pd.read_csv(url, names=names, skiprows=1, parse_dates={"Datetime" : ['dt']})
  ...
  plt.plot(so2cosp['Datetime'], dfratcosp, marker='o', markersize=10, color = 'red', linewidth = 2, label = 'CO2/SO2-cosp') 
  ...
  plt.plot(so2cont['Datetime'], dfratcont, marker='o', markersize=10, color = 'blue', linewidth = 2, label = 'CO2/SO2-cont') 
  ...
  dfrsam = pd.read_csv(rsamfile, names=rsamnames, delim_whitespace=True, parse_dates={"Datetime" : ['dt']})
  ...
  plt.plot(plot['Datetime'], plot['obs'], marker='None', color = 'red', linewidth = 2, label = 'RSAM') 
